          ...
          <div className="grid grid-cols-2 gap-10 items-center">
            <div className="flex flex-col gap-4">
              ...
              <p className="!text-white">
                ...
                minus quibusdam ipsa illo quisquam quo magni minima libero
                doloremque dolores.
              </p>
              <Button
                variant="secondary"
                className="text-white w-fit px-10 py-6 text-md light-bg :hover-light-bg relative z-0 overflow-hidden"
              >
                Get Started
              </Button>
            </div>
            <div className="banner-img">
              <div className="banner-icon banner-icon-1">
                <img src="/assets/imgs/microphone.svg" alt="" />
              </div>
              <div className="banner-icon banner-icon-2">
                <img src="/assets/imgs/target.svg" alt="" />
              </div>
              <img
                src="/assets/imgs/hero-img.png"
                className="w-full h-full max-w-[500px] ms-auto relative z-10"
                alt=""
              />
            </div>
          </div>
        ...
        <div className="custom-container">
          <div className="grid grid-cols-2 gap-10 items-center">
            <div>
              <img
                src="/assets/imgs/hero-img.png"
                className="w-full h-full max-w-[500px] mr-auto"
                alt=""
              />
            </div>
            <div>
              ...
              <Button
                variant="default"
                className="p-6 text-md relative z-0 overflow-hidden"
              >
                Get Started
              </Button>
            </div>
          ...
          <div className="grid grid-cols-2 gap-10 items-center">
            <div>
              <div className="flex flex-col justify-start gap-4">
                <div className="section-title-bage white-bage !mx-0">
                  <span>Testimonials</span>
                </div>
                <h2 className="!text-white">Lorem ipsum dolor sit</h2>
                <p className="!text-white">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Architecto voluptates exercitationem soluta. Corrupti quidem
                  nisi unde, repellendus quibusdam nam laborum!
                </p>
              </div>
            </div>
            <div>
                ...
                <CarouselContent>
                  <CarouselItem className="md:basis-1/2 lg:basis-1/2">
                    <div className="card p-6 bg-white rounded-xl flex flex-col gap-5">
                      ...
                      <p className="!text-sm">
                        “Their feedback fuel our passion for continuous
                        improvement and The innovation. We take immense pride in
                        the relationships we’ve built and the trust we’ve earned
                        through.”
                      </p>
                      <div className="flex justify-between items-center">
                        <div className="flex gap-3 items-center">
                          <img
                            src="/assets/imgs/testimonial-user-img.png"
                            className="w-10 h-10 rounded-full"
                            alt=""
                          />
                          <div>
                            <p className="!text-[14px] leading-normal text-black font-semibold">
                              Lorem, ipsum.
                            </p>
            ...
            <div className="border border-gray-300 rounded-xl shadow-sm">
              <div className="card p-6 flex flex-col gap-4">
                ...
                <p className="!text-gray-500">
                  ...
                  possimus vero voluptatum impedit nostrum veritatis.
                </p>
